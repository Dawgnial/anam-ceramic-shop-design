  ...
  return (
    <section className="bg-background overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
        {/* Right side - Pottery */}
        <div
          className={`relative h-[280px] sm:h-[350px] md:h-[450px] lg:h-[555px] transition-transform duration-1000 ${
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white px-4 sm:px-6">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-1 sm:mb-2">فروش ویژه</h2>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-4">ظروف سرامیکی</h3>
              <p className="text-xs sm:text-sm mb-4 sm:mb-6 leading-relaxed max-w-sm sm:max-w-md mx-auto hidden sm:block">
