...
export const Welcome = () => {
  ...
  return (
    <section className="bg-background overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 items-center relative isolate">
        {/* Right side - Image */}
        <div
          className={`relative z-0 transition-transform duration-1000 ${
            isVisible ? "translate-x-0" : "translate-x-full"
          }`}
        >
          <img
            src={welcomeImg1}
            alt="خوش آمدید به فروشگاه آنلاین ظروف سرامیکی"
        ...
        {/* Left side - Image */}
        <div
          className={`relative z-0 transition-transform duration-1000 hidden md:block ${
            isVisible ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          <img
        ...
        {/* Text box overlay - ABOVE both images */}
        <div
          className="absolute inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 md:p-8 pointer-events-none"
          style={{ zIndex: 9999 }}
        >
          <div
            className="border-2 sm:border-4 p-4 sm:p-6 md:p-8 lg:p-12 text-center relative pointer-events-auto"
            style={{
              borderColor: "#FCE8D9",
          ...
          >
            ...
            <p
              className="text-xs sm:text-sm md:text-base leading-relaxed mb-4 sm:mb-6 hidden sm:block font-normal"
              style={{ color: "#A9A9A9" }}
            >
