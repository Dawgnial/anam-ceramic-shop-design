import { Home, Package, FolderTree, ShoppingCart, FileText, Users, Tag, MessageSquare, Warehouse, LayoutDashboard, Headphones } from "lucide-react";
...
const items = [
  ...
  { title: "پشتیبانی", url: "/admin/support", icon: Headphones },
